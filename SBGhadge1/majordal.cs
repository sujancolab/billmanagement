...
namespace SBGhadgev1
{
    ...
    class majordal
    {
        ...
        public static string constr = string.Format(@"Provider=Microsoft.ACE.OLEDB.12.0;Data Source={0}\sbghadge.accdb;Jet OLEDB:Database Password=sbg123", Application.StartupPath);
